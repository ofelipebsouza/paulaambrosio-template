...
export const locationsData: LocationData[] = [
  {
    id: 'miami-beach',
    slug: 'interior-designer-miami-beach',
    url: '/interior-designer-miami-beach',
    city: 'Miami Beach',
    title: 'Miami Beach',
    seoTitle: 'Luxury Interior Designer Miami Beach | Paula Ambrosio Interiors',
    metaDescription: 'Paula Ambrosio Interiors provides luxury residential and turnkey interior design for discerning clients in Miami Beach and South Florida.',
    heroHeadline: 'Luxury Interior Designer in Miami Beach',
    ...
    hubOneLiner: 'Historic Art Deco architectural dialogue, exclusive island enclaves, and oceanfront sanctuaries designed for effortless indoor-outdoor living.',
    localIntro: 'Miami Beach represents a unique intersection of legendary architectural heritage, oceanfront vistas, and international cosmopolitan living. From the ultra-private waterfront estates of Star Island, Palm Island, and the Venetian Islands to high-elevation condominiums along Collins Avenue and South of Fifth (SoFi), designing residences here demands an intimate understanding of coastal elements. Our studio approaches Miami Beach interiors by harmonizing expansive natural light with tactile, grounding organic materials—counterbalancing the vivid ocean horizon with rich woods, honed travertines, and bespoke furnishings that withstand maritime microclimates while feeling utterly luxurious. Whether reimagining a Mediterranean-revival villa on the Venetian Islands, designing a contemporary waterfront estate on Star Island, or transforming a high-rise penthouse in SoFi, every project begins with a deep appreciation for the interplay between indoor refinement and the dynamic outdoor environment. We specialize in navigating the unique logistical demands of island properties—from bridge access restrictions and HOA architectural review boards to hurricane-rated glazing specifications and salt-air-resistant material selections—ensuring that each residence not only reflects sophisticated design sensibility but is engineered to endure Miami Beach\'s distinctive coastal conditions with enduring beauty and performance.',
    services: [
      'Full-Service Interior Design',
      'Waterfront Estate Architecture & Planning',
      'Luxury Condominium Renovations',
      'Turnkey Second Home Design',
      'Custom Italian Millwork & Cabinetry',
      'Fine Art Curation & Lighting Engineering'
    ],
    featuredProjectSlug: 'home-fl',
    processSteps: [
      { step: '01', title: 'Consultation & Discovery', description: 'In-depth assessment of your lifestyle, spatial aspirations, and coastal property characteristics.' },
      { step: '02', title: 'Concept & 3D Visualization', description: 'Photorealistic render visualizations establishing materials, spatial layout, and custom millwork.' },
      { step: '03', title: 'Design Development', description: 'Detailed architectural drawings, finish schedules, electrical plans, and custom specifications.' },
      { step: '04', title: 'Procurement & Coordination', description: 'Global sourcing from Italian and European ateliers with complete vendor and logistics oversight.' },
      { step: '05', title: 'Installation & White-Glove Styling', description: 'White-glove delivery, millwork installation, art hanging, fine accessory placement, and final reveal.' }
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer: 'Seamless collaboration is central to our process. We coordinate directly with your architect, structural engineers, and licensed general contractor, providing exact interior architectural sets, electrical drops, and plumbing rough-in schedules.'
      }
    ],
    heroImage: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1600&q=85',
    galleryImages: [
      { url: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1200&q=85', alt: 'Waterfront living room in Miami Beach' },
      { url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85', alt: 'Bespoke marble kitchen in Star Island residence' },
      { url: 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=1200&q=85', alt: 'Primary suite overlooking Biscayne Bay' }
    ],
    highlights: ['Star Island & Palm Island', 'Venetian Islands', 'South of Fifth (SoFi)', 'Sunset Islands', 'Collins Ave Oceanfront']
  },
  {
    id: 'sunny-isles',
    slug: 'interior-designer-sunny-isles',
    url: '/interior-designer-sunny-isles',
    city: 'Sunny Isles Beach',
    title: 'Sunny Isles Beach',
    seoTitle: 'Luxury Interior Designer Sunny Isles Beach | Paula Ambrosio Interiors',
    metaDescription: 'Paula Ambrosio Interiors provides luxury residential and turnkey interior design for discerning clients in Sunny Isles Beach and South Florida.',
  ...
  {
    id: 'aventura',
    slug: 'interior-designer-aventura',
    url: '/interior-designer-aventura',
    city: 'Aventura',
    title: 'Aventura',
    seoTitle: 'Luxury Interior Designer Aventura | Paula Ambrosio Interiors',
    metaDescription: 'Paula Ambrosio Interiors provides luxury residential and turnkey interior design for discerning clients in Aventura and South Florida.',
  ...
  {
    id: 'bal-harbour',
    slug: 'interior-designer-bal-harbour',
    url: '/interior-designer-bal-harbour',
    city: 'Bal Harbour',
    title: 'Bal Harbour',
    seoTitle: 'Luxury Interior Designer Bal Harbour | Paula Ambrosio Interiors',
    metaDescription: 'Paula Ambrosio Interiors provides luxury residential and turnkey interior design for discerning clients in Bal Harbour and South Florida.',
  ...
  {
    id: 'boca-raton',
    slug: 'interior-designer-boca-raton',
    url: '/interior-designer-boca-raton',
    city: 'Boca Raton',
    title: 'Boca Raton',
    seoTitle: 'Luxury Interior Designer Boca Raton | Paula Ambrosio Interiors',
    metaDescription: 'Paula Ambrosio Interiors provides luxury residential and turnkey interior design for discerning clients in Boca Raton and South Florida.',
  ...
  {
    id: 'palm-beach',
    slug: 'interior-designer-palm-beach',
    url: '/interior-designer-palm-beach',
    city: 'Palm Beach',
    title: 'Palm Beach',
    seoTitle: 'Luxury Interior Designer Palm Beach | Paula Ambrosio Interiors',
    metaDescription: 'Paula Ambrosio Interiors provides luxury residential and turnkey interior design for discerning clients in Palm Beach and South Florida.',
  ...
  },
  {
    ...
    city: 'Miami',
    title: 'Miami (Flagship Hub)',
    seoTitle: 'Luxury Interior Designer Miami | Paula Ambrosio Interiors',
    metaDescription: 'Luxury interior design in Miami by Paula Ambrosio Interiors. Full-service residential design, renovations, custom homes, turnkey interiors and project coordination.',
    heroHeadline: 'Luxury Interior Designer in Miami',
    heroSubheadline: 'Full-Service Interior Design & Turnkey Solutions for Exceptional Miami Residences',
    hubOneLiner: 'South Florida’s vibrant cultural capital—from Brickell penthouses and Coconut Grove estates to Key Biscayne waterfronts and Coral Gables manors.',
    localIntro: 'Miami architecture offers extraordinary possibilities: waterfront homes filled with natural light, sophisticated high-rise residences, contemporary estates and international second homes. Our approach begins by understanding how our clients live. Paula Ambrosio Interiors is a Miami-based luxury interior design studio specializing in high-end residential interiors, renovations, new construction and complete turnkey transformations across South Florida and internationally.',
    services: [
      'Full-Service Interior Design',
      'New Construction Interior Architecture',
      'Luxury Renovations & Space Planning',
      'Turnkey Interior Design & Furnishing',
      'Custom Millwork & Cabinetry Design',
      'Furniture & Fine Art Curation'
    ],
    featuredProjectSlug: 'brickell-waterfront',
    processSteps: [
    ...
    galleryImages: [
      { url: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1200&q=85', alt: 'Miami luxury open living space' },
      { url: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1200&q=85', alt: 'Brickell high-rise living salon' },
      { url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85', alt: 'Architectural kitchen in Miami custom home' }
    ],
    highlights: ['Brickell', 'Coconut Grove', 'Coral Gables', 'Key Biscayne', 'Bay Harbor Islands', 'Golden Beach', 'Design District']
  }
];
