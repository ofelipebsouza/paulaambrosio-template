...
interface SunnyIslesPageProps {
  onNavigate: (path: string) => void;
  onOpenConsultation: (service?: string, location?: string) => void;
}

export const SunnyIslesPage: React.FC<SunnyIslesPageProps> = ({ onNavigate, onOpenConsultation }) => {
  const location = locationsData.find(loc => loc.id === 'sunny-isles') || locationsData[1];
  const featuredProject = projectsData.find(p => p.slug === 'the-regalia-penthouse') || projectsData[0];
  const relatedHighRiseProjects = projectsData.filter(p => p.id === 'home-s' || p.id === 'home-fl');
  ...
  const sunnyIslesGallery = [
    {
      badge: 'Oceanfront Sky Salon',
    ...
    {
      badge: 'Formal Dining Area',
      title: 'Ocean View Dining Pavilion',
      subtitle: 'The Regalia Penthouse • Sunny Isles Beach',
      category: 'Dining & Entertaining',
      description: 'Hand-cast bronze statement chandelier, solid timber dining table, and tailored leather seating.',
      url: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=1600&q=85'
    },
    {
      badge: 'Primary Sanctuary',
      title: 'Horizon Primary Bedroom Suite',
      subtitle: 'The Regalia Penthouse • Sunny Isles Beach',
      category: 'Primary Bedroom',
      description: 'Silk-textured acoustic wall paneling, automated Lutron solar sheers, and floating walnut nightstands.',
      url: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=1600&q=85'
    },
    {
      badge: 'Sky Spa Suite',
      title: 'Panoramic Atlantic Spa Bathroom',
      subtitle: 'The Regalia Penthouse • Sunny Isles Beach',
      category: 'Spa & Wellness Bath',
      description: 'Freestanding sculptural tub framing endless water views, brushed champagne brass fixtures, and honed marble.',
    ...
    },
    {
      ...
      title: 'Tactile Noble Material Palette',
      subtitle: 'Stone, Hardwood & Performance Textiles',
      category: 'Material Detail',
      description: 'Honed Roman travertine, fluted Canaletto walnut, Taj Mahal quartzite, and Loro Piana acoustic fabrics.',
      url: '/assets/uJDafV2OYdKY0ezWt4AhW3Dpj0.avif'
    }
  ];

  // Specific services tailored to Sunny Isles Beach
  const applicableServices = [
    {
      title: 'Full-Service Interior Design',
      description: 'End-to-end design stewardship for oceanfront penthouses and luxury condominiums, coordinating spatial concepts, material finishes, and lighting schemes with your builder.',
      linkText: 'Explore Residential Scope',
      linkTarget: '/luxury-residential-interior-design-miami'
    },
    {
      title: 'Luxury Renovation',
      description: 'Modernizing premier condominium residences by reconfiguring compartmentalized floor plates into luminous open volumes while managing strict building HOA guidelines.',
      linkText: 'Renovation Capabilities',
      linkTarget: '/luxury-residential-interior-design-miami'
    },
    {
      title: 'New Construction Interior Design',
      description: 'Collaborating during pre-construction and developer option selection to optimize floor plans, electrical rough-ins, ceiling drops, and plumbing prior to drywall installation.',
    ...
    <div className="min-h-screen pt-20">
      ...
      <div className="bg-[#FAF9F6] border-b border-[#EAE4DB] py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center space-x-2 text-xs text-[#7A746E]">
          ...
          <ChevronRight className="w-3 h-3 text-[#B8B1A8]" />
          <span className="text-[#1A1816] font-medium">Sunny Isles Beach</span>
        </div>
      </div>
      ...
      <section className="relative min-h-[75vh] flex items-center bg-[#171513] text-white overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Luxury Interior Designer Sunny Isles Beach - Paula Ambrosio Interiors"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
          <div className="max-w-3xl space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#C9A986]/20 border border-[#C9A986]/40 text-[#E8D8C8] text-xs uppercase tracking-widest backdrop-blur-xs">
              ...
              <span>Oceanfront High-Rise & Turnkey Living</span>
            </div>

            <h1 className="font-serif-luxury text-4xl sm:text-6xl font-normal leading-tight text-white">
              Luxury Interior Designer in Sunny Isles Beach
            </h1>

            <p className="font-serif-luxury text-xl sm:text-2xl text-[#DCD5CB] italic font-light max-w-2xl">
              Full-service residential design for oceanfront condominiums, high-rise residences, second homes and turnkey interiors.
            </p>

            <p className="text-sm sm:text-base text-[#B8B1A8] font-light leading-relaxed max-w-xl">
              From landmark towers like The Regalia, Armani/Casa, and Porsche Design to private oceanfront penthouses, Paula Ambrosio Interiors transforms sky estates into refined, move-in-ready sanctuaries.
            </p>

            <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <button
                onClick={() => onOpenConsultation('Start Your Sunny Isles Beach Project', 'Sunny Isles Beach')}
              ...
              >
                START YOUR SUNNY ISLES BEACH PROJECT
              </button>
              
              <button
                onClick={() => onOpenConsultation('Request a Private Consultation - Sunny Isles Beach', 'Sunny Isles Beach')}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="text-xs uppercase tracking-[0.2em] text-[#C9A986] font-semibold">
                Vertical Oceanfront Living
              </div>
              <h2 className="font-serif-luxury text-3xl sm:text-4xl text-[#1A1816] font-normal leading-tight">
                Atmosphere, Acoustic Serenity & Ocean Light
              </h2>
              
              {/* 150-250 Unique Words about Sunny Isles residential context */}
              ...
              {/* Landmark Tower Highlights */}
              <div className="pt-2">
                <div className="text-xs font-semibold uppercase tracking-wider text-[#1A1816] mb-2">
                  Recognized Sunny Isles Oceanfront Addresses:
                </div>
                <div className="flex flex-wrap gap-2">
                  {location.highlights.map((tower, idx) => (
              ...
              <div className="p-4 bg-[#F2EDE5] border border-[#E2DBD1] flex items-start gap-3">
                ...
                <div className="text-xs text-[#68625B] leading-relaxed">
                  <span className="font-semibold text-[#1A1816]">Condominium Coordination:</span> We coordinate directly with building property managers, licensed general contractors, and structural engineers, managing strict freight schedules, acoustic membrane certifications, and permit packages.
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-4">
              <div className="relative">
                <img
                  ...
                  alt="Sunny Isles Beach oceanfront dining and living salon"
                ...
                <div className="absolute -bottom-4 -right-4 bg-white p-4 border border-[#E2DBD1] shadow-md hidden sm:block max-w-xs">
                  <p className="text-[11px] uppercase tracking-widest text-[#C9A986] font-semibold">The Regalia Sky Residence</p>
                  <p className="text-xs text-[#524D47] mt-1 font-light">Turnkey Furnishing, Custom Millwork & 360° Ocean Horizon Orientation</p>
                </div>
              </div>
      ...
      {/* Services Tailored to Sunny Isles Beach */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14 space-y-2">
            ...
            <h2 className="font-serif-luxury text-3xl sm:text-4xl text-[#1A1816] font-normal">
              Services for Sunny Isles Beach Residences
            </h2>
            <p className="text-xs sm:text-sm text-[#736D65] font-light max-w-2xl mx-auto">
              Our multidisciplinary studio provides comprehensive interior design, high-rise renovation planning, custom millwork engineering, and turnkey staging tailored to oceanfront towers.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              ...
              <h2 className="font-serif-luxury text-3xl sm:text-4xl text-[#1A1816] font-normal">
                Sunny Isles Beach Photography & Detail Archive
              </h2>
              <p className="text-xs sm:text-sm text-[#736D65] mt-1 font-light">
                Inspect actual sky salon volumes, primary oceanfront suites, and tactile finish specifications.
              </p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sunnyIslesGallery.map((item, idx) => (
              <div
                key={idx}
      ...
      {/* Featured Verified Project: The Regalia Penthouse */}
      <section className="py-24 bg-white border-b border-[#EAE4DB]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="max-w-3xl mb-12 space-y-2">
            <div className="text-xs uppercase tracking-[0.2em] text-[#C9A986] font-semibold">
              Verified Sunny Isles Beach Case Study
            </div>
            <h2 className="font-serif-luxury text-3xl sm:text-4xl text-[#1A1816] font-normal">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 bg-[#FAF9F6] border border-[#E5DFD7] p-8 sm:p-10 shadow-xs">
            <div className="lg:col-span-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs text-[#68625B] pt-2">
                <div className="p-3 bg-white border border-[#E5DFD7]">
                  ...
                  <span className="font-medium text-[#1A1816]">Sunny Isles Beach • Oceanfront Penthouse</span>
                </div>
                <div className="p-3 bg-white border border-[#E5DFD7]">
            ...
            <div className="lg:col-span-6 flex flex-col justify-between space-y-6">
              ...
              <div className="pt-4 border-t border-[#EAE4DB] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                >
                  <span>Read Complete Regalia Case Study</span>
                  <ArrowRight className="w-3.5 h-3.5 text-[#C9A986]" />
                </button>
                <button
                  onClick={() => onOpenConsultation('Discuss a Sunny Isles Penthouse Project', 'Sunny Isles Beach')}
                  className="text-xs uppercase tracking-wider text-[#C9A986] hover:underline"
                >
                  Discuss Similar Penthouse →
                </button>
              </div>
            </div>
          </div>

          {/* Related High-Rise & Waterfront Projects */}
          <div className="mt-14 pt-10 border-t border-[#EAE4DB]">
            <div className="flex items-center justify-between mb-6">
              <h3 className="font-serif-luxury text-xl text-[#1A1816]">
                More Coastal & High-Rise Case Studies
              </h3>
              <button
                onClick={() => onNavigate('/portfolio')}
      ...
      <ProcessTimeline
        title="Sunny Isles Beach Interior Design Process"
        ...
        onStartProject={() => onOpenConsultation('Start Your Sunny Isles Beach Project', 'Sunny Isles Beach')}
      />

      {/* Frequently Asked Questions */}
      <FAQAccordion
        title="Sunny Isles Beach Interior Design FAQ"
        subtitle="Essential considerations for owners undertaking high-rise interior architecture, renovations, or turnkey living."
        faqs={location.faqs}
      />
      ...
      <section className="py-20 bg-[#171513] text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 text-[#E8D8C8] text-xs uppercase tracking-widest backdrop-blur-xs">
            ...
            <span>Sunny Isles Beach Private Commissions</span>
          </div>
          ...
          <p className="text-sm sm:text-base text-[#B8B1A8] max-w-xl mx-auto font-light">
            Contact Paula Ambrosio Interiors to schedule a private consultation for your oceanfront condominium or sky penthouse.
          </p>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-wrap justify-center gap-6 text-xs text-[#B8B1A8]">
            ...
            <span>•</span>
            <a
              href="/portfolio/the-regalia-penthouse"
              onClick={(e) => { e.preventDefault(); onNavigate('/portfolio/the-regalia-penthouse'); }}
              className="hover:text-white transition-colors"
            >
              The Regalia Penthouse Case Study
            </a>
            <span>•</span>
            <a
              href="/locations"
            ...
            <div className="p-6 bg-[#1C1A18] border-t border-[#332F2B] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <button
                onClick={() => {
                  ...
                  onOpenConsultation(`Inquiry for Sunny Isles: ${selectedPhoto.title}`, 'Sunny Isles Beach');
                }}
